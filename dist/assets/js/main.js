...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "openCatalogMenu": function() { return /* binding */ openCatalogMenu; },
/* harmony export */   "openCatalogSecondMenu": function() { return /* binding */ openCatalogSecondMenu; },
/* harmony export */   "openCatalogSubMenu": function() { return /* binding */ openCatalogSubMenu; }
/* harmony export */ });
...
var openCatalogSubMenu = function openCatalogSubMenu() {
  var wrap = document.querySelectorAll('.js--openSubMenu');
  if (wrap.length == 0) return;
  wrap.forEach(function (elem) {
    var btn = elem.querySelector('.js--openSubMenu-btn');
    var content = elem.querySelector('.js--openSubMenu-content');
    var menuMobile = content.closest('.js--openMobileMenu-content');
    if (!btn || !content) return;
    var plus = elem.querySelector('.js--openSubMenu-plus');
    var minus = elem.querySelector('.js--openSubMenu-minus');
...
var openCatalogSecondMenu = function openCatalogSecondMenu() {
  var wrap = document.querySelectorAll('.js--openMobileMenu');
  if (wrap.length == 0) return;
  if (window.innerWidth < 992) {
    wrap.forEach(function (elem) {
  ...
  wrap.forEach(function (elem, index) {
    var btn = elem.querySelector('.js--openMobileMenu-item');
    var content = elem.querySelector('.js--openMobileMenu-content');
    var active = elem.querySelector('.catalog-menu__item');
    var menu_desctop = document.querySelectorAll('.js--catalog-menu-detail');
    if (!btn || !content) return;
    content.style.setProperty('max-height', 0);
    btn.addEventListener('click', function () {
      if (window.innerWidth > 991) {
        menu_desctop.forEach(function (elems) {
        ...
        document.querySelectorAll('.js--openMobileMenu-item .catalog-menu__item').forEach(function (el) {
...
/***/ "./src/components/app-category/category.js":
/*!*************************************************!*\
  !*** ./src/components/app-category/category.js ***!
  \*************************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "showAccordion": function() { return /* binding */ showAccordion; }
/* harmony export */ });
...
var showModal = function showModal() {
  ...
  btn.forEach(function (elem) {
    ...
    if (!overlay) return;
    var close = overlay.querySelector('.js--overlay-close');
    var card_content = '';
    elem.addEventListener('click', function (e) {
      var margin = window.innerWidth - document.body.clientWidth;
      e.preventDefault();
      document.documentElement.style.overflowY = 'hidden';
...
/***/ "./src/components/app-sliders/slider.js":
/*!**********************************************!*\
  !*** ./src/components/app-sliders/slider.js ***!
  \**********************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "sliderBasicInit": function() { return /* binding */ sliderBasicInit; },
/* harmony export */   "sliderCompareInit": function() { return /* binding */ sliderCompareInit; }
/* harmony export */ });
/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper */ "./node_modules/swiper/swiper.esm.js");

var sliderBasicInit = function sliderBasicInit() {
  var sliders = document.querySelectorAll('.js--swiper-basic');
  if (sliders.length === 0) return;
  sliders.forEach(function (slider) {
    new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('#' + slider.id + ' .swiper', {
...
var sliderCompareInit = function sliderCompareInit() {
  var sliders = document.querySelectorAll('.js--swiper-compare');
  if (sliders.length === 0) return;
  sliders.forEach(function (slider) {
    new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('#' + slider.id + ' .swiper', {
      modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation],
...
/***/ "./src/components/app-stars/star.js":
/*!******************************************!*\
  !*** ./src/components/app-stars/star.js ***!
  \******************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
var changeStars = function changeStars() {
  var assssmnt = document.querySelectorAll('[data-assssmnt]');
  if (assssmnt.length == 0) return;
  assssmnt.forEach(function (elem) {
    var stars = elem.querySelectorAll('.assessment-star');
    var input = elem.querySelector('input');
    stars.forEach(function (element, item) {
...
/* harmony default export */ __webpack_exports__["default"] = (changeStars);
...
/***/ "./src/components/show-more/show.js":
/*!******************************************!*\
  !*** ./src/components/show-more/show.js ***!
  \******************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
var showMore = function showMore() {
  var wrapper = document.querySelectorAll('.js--show-more');
  if (wrapper.length === 0) return;
  wrapper.forEach(function (wrap) {
    var btn = wrap.querySelector('.js--show-more--btn');
    var content = wrap.querySelector('.js--show-more--content');
    var row = 3;
    if (wrap.hasAttribute('data-show-content-row')) row = wrap.getAttribute('data-show-content-row');
    var heightStart = content.querySelector('a').scrollHeight * row;
    var ob = content.querySelector('div');
    if (!btn || !content) return;
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper */ "./node_modules/swiper/swiper.esm.js");
/* harmony import */ var _components_header_header_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/_header/header.js */ "./src/components/_header/header.js");
/* harmony import */ var _components_burger_burger_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/burger/burger.js */ "./src/components/burger/burger.js");
/* harmony import */ var _components_app_catalog_catalog_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/app-catalog/catalog.js */ "./src/components/app-catalog/catalog.js");
...
/* harmony import */ var _components_app_sliders_slider_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/app-sliders/slider.js */ "./src/components/app-sliders/slider.js");
...
/* harmony import */ var _components_app_fixed_fixed_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../components/app-fixed/fixed.js */ "./src/components/app-fixed/fixed.js");
/* harmony import */ var _components_app_category_category_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../components/app-category/category.js */ "./src/components/app-category/category.js");
/* harmony import */ var _components_show_more_show_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../components/show-more/show.js */ "./src/components/show-more/show.js");
...
window.addEventListener('load', function () {
  _components_header_header_js__WEBPACK_IMPORTED_MODULE_1__.changeDatalist();
  (0,_components_burger_burger_js__WEBPACK_IMPORTED_MODULE_2__["default"])();
  _components_app_catalog_catalog_js__WEBPACK_IMPORTED_MODULE_3__.openCatalogMenu();
  _components_app_catalog_catalog_js__WEBPACK_IMPORTED_MODULE_3__.openCatalogSubMenu();
  _components_app_catalog_catalog_js__WEBPACK_IMPORTED_MODULE_3__.openCatalogSecondMenu();
  ...
  (0,_components_scroll_js__WEBPACK_IMPORTED_MODULE_8__["default"])();
  (0,_components_app_fixed_fixed_js__WEBPACK_IMPORTED_MODULE_9__["default"])();
  ...
  (0,_components_show_more_show_js__WEBPACK_IMPORTED_MODULE_11__.showMore)();
  ...
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".preview-swiper", {
    slidesPerView: 1,
  ...
  var swipetReviews = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".slider-reviews .slider-reviews_images", {
    slidesPerView: 1
  });
  var reviewsSlider = document.querySelectorAll('.slider-reviews-preview');
  if (reviewsSlider.length != 0) {
    reviewsSlider.forEach(function (elems) {
      var photos = elems.querySelectorAll('.slider-reviews_image');
  ...
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".similar-sliders .similar-slider", {
    slidesPerView: 1,
    modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation],
    spaceBetween: 8,
    navigation: {
  ...
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".buy-sliders .buy-slider", {
    slidesPerView: 1,
    modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation],
    spaceBetween: 8,
    navigation: {
  ...
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".top-sliders .top-slider", {
    slidesPerView: 1,
    modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation],
    spaceBetween: 8,
    navigation: {
  ...
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".product-sliders .product-slider", {
    slidesPerView: 1,
    modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation],
    spaceBetween: 8,
    navigation: {
